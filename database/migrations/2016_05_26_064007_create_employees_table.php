...
class CreateEmployeesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Employees", 'employees', 'name', 'fa-group', [
            ["name", "氏名", "String", false, "", 5, 250, true],
            ["gender", "性別", "Radio", false, "Male", 0, 0, true, ["Male","Female"]],
            ["mobile", "携帯電話", "Mobile", false, "", 10, 20, true],
            ["mobile2", "Alternative Mobile", "Mobile", false, "", 10, 20, false],
            ["email", "メール", "Email", true, "", 5, 250, true],
            ...
            ["date_birth", "生年月日", "Date", false, "1990-01-01", 0, 0, false],
