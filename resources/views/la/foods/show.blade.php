...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $food->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Foods", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/foods/'.$food->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Foods", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.foods.destroy', $food->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/foods') }}" data-toggle="tooltip" data-placement="right" title="Back to Foods"><i class="fa fa-chevron-left"></i></a></li>
