...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		...
		<div class="col-md-1 actions">
			@la_access("Buses", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/buses/'.$bus->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Buses", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.buses.destroy', $bus->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/buses') }}" data-toggle="tooltip" data-placement="right" title="Back to Buses"><i class="fa fa-chevron-left"></i></a></li>
