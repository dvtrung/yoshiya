...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $karute->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Karutes", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/karutes/'.$karute->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Karutes", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.karutes.destroy', $karute->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/karutes') }}" data-toggle="tooltip" data-placement="right" title="Back to Karutes"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'time')
						@la_display($module, 'groupName')
						@la_display($module, 'tourCompany')
						@la_display($module, 'front_name')
						@la_display($module, 'bus_name')
						@la_display($module, 'bus_num')
						@la_display($module, 'options')
						@la_display($module, 'paymentMethod')
						@la_display($module, 'contact')
						@la_display($module, 'contact_num')
						@la_display($module, 'hall_note')
						@la_display($module, 'pref')
						@la_display($module, 'uketsuke')
						@la_display($module, 'nyuryoku')
						@la_display($module, 'tantou')
