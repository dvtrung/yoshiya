...
@section('contentheader_description') 店の概要 @endsection
            ...
            <section class="col-lg-7 connectedSortable">
              ...
              <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs pull-right">
                  <li class="pull-left header"><i class="fa fa-calendar"></i> 予約カレンダー</li>
                </ul>
              ...
              <div class="nav-tabs-custom">
                <!-- Tabs within a box -->
                <ul class="nav nav-tabs pull-right">
                  <li class="pull-left header"><i class="fa fa-calendar"></i> 今日の予約</li>
                </ul>
                <div class="tab-content no-padding">
                  <table class="table table-heading table-bordered">
                    <tr>
                      ...
                      <tr>
                        <td>{{ $res->time }}</td>
                        <td>{{ $res->groupName }}</td>
                        <td>{{ $res->contact }}: {{ $res->contact_num }}</td>
                      </tr>
                      @endforeach
                  </table>
